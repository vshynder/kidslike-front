        ...
        childrens: [
            {
                ...
                balance: 32,
                tasks: [
                    {name: "Викинути смiття", cost: 4},
                    {name: "Помити посуд", cost: 5}
                ]
            },
            {
                id: 2,
                ...
                balance: 42,
                tasks: [
                    {name: "Прибрати кiмнату", cost: 7},
                    {name: "11 в щоденнику", cost: 5}
                ]
            },
            {
                id: 3,
        ...
        return(
            <div className={style.childrenSidebar_container}>
                <div className={style.childrenSidebar_header}>
                    <img className={style.childrenSidebar_house} src={house} alt="home"></img>
