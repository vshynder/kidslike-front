...
const ChangeHabbitForm = () => {
  ...
  return (
    <div className={styles.changehabbit__form}>
      ...
      <div onClick={handleDeleteHabbit} className={styles.changehabbit__delete}>
        ...
        <span className={styles.changehabbit__deleteText}>Видалити задачу</span>
      </div>
...
export default ChangeHabbitForm;
